...
class New_step3_4(QWidget):
    ...
    def initUI(self):
        ...
        self.button_previous.clicked.connect(self.parent.open_new_step_3_3)
        ...
        self.button_next.clicked.connect(self.parent.open_new_step_4_1)
