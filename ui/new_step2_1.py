...
class New_step2_1(QWidget):
    ...
    def initUI(self):
        ...
        self.button_previous.clicked.connect(self.parent.open_new_step_1_5)
        ...
        self.button_next.clicked.connect(self.parent.open_new_step_2_2)
