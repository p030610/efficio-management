...
class New_step2_2(QWidget):
    ...
    def initUI(self):
        ...
        self.button_previous.clicked.connect(self.parent.open_new_step_2_1)
        ...
        self.button_next.clicked.connect(self.parent.open_new_step_3_1)
